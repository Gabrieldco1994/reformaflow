...
export class AgentService {
  ...
  private systemPrompt(projectId?: string | null): string {
    ...
    return [
      ...
      '- Vínculo cross-project (mesma despesa que já existe em outro projeto, p/ evitar dupla contagem):',
      '  use find_expenses para achar a despesa-alvo e passe linkedExpenseId no create_expense.',
      ...
      '- Para onde foi o dinheiro: get_expenses_by_category; ao separar essencial x supérfluo, explique o critério.',
