...
export class PrismaService extends PrismaClient implements OnModuleInit, OnModuleDestroy {
  constructor() {
    ...
    const modelsWithoutSoftDelete = new Set(['SimulationValue', 'Simulation', 'FloorPlanRoom', 'RoomImage', 'FloorPlanMarker', 'CarInfo', 'MerchantCategory', 'CrossProjectSettlement', 'RateioAllocation', 'PlantDiagnosisLog', 'Feedback', 'UserActivityLog', 'PricePoint']);
