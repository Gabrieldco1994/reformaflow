...
export const FINANCE_CENTER_IDS = {
  ...
  expenses: {
    ...
    tenantScopedForeign: "fc-a-exp-tenant-scoped-foreign",
...
async function createFinancialRelationships(
  ...
  await tx.expense.createMany({
    data: [
      ...
      expenseRow({
        ...
        projectId: IDS.projects.allowed,
        title: "Planejado com colisão cross-tenant sintética",
        total: 4_006,
        day: "2026-08-14",
        cardLast4: "1111",
  ...
  await tx.cashFlowEntry.createMany({
    data: [
      ...
      {
        ...expenseEntry(
          "fc-a-cfe-mirror-target",
          IDS.expenses.mirrorTarget,
          90_040,
          "2026-07-05",
        ),
        projectId: IDS.projects.allowed,
...
async function createTenantBCollisions(
  ...
  await tx.expense.create({
    data: {
      ...
      valorTotal: 4_006,
      formaPagamento: "A_VISTA",
      dataPagamento: D("2026-08-14"),
      dataCompra: D("2026-08-14"),
      status: "PLANEJADO",
      cardLast4: "1111",
      externalId: "fc-tenant-scope-collision",
