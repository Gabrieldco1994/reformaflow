/**
 * Validação visual — Fase A Design System.
 * Mostra todas as variantes de KpiTile lado a lado para aceite visual em 360px
 * e desktop.
 *
 * Client component porque os quick-filters de exemplo têm `onClick`. O guard de
 * produção NÃO pode morar aqui: em client component `notFound()` roda depois de
 * o bundle ter sido servido. Ele mora no `page.tsx` (server), que é quem
 * decide se esta árvore chega a existir.
 */
...
export function PrototypeKpiClient() {
