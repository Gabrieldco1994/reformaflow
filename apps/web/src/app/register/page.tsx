          ...
          <section className="min-w-0 border-b border-lifeone-hairline p-5 sm:p-8 lg:border-b-0 lg:border-r">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div>
                ...
                <input id="email" name="email" type="email" autoComplete="email" value={email} onChange={(event) => setEmail(event.target.value)} className={fieldClass} placeholder="exemplo@email.com" />
              </div>
              <div>
