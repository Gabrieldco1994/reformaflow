...
describe("ExpensesView — PESSOAL com rateio (Telha Norte, issue #428 follow-up)", () => {
  ...
  const rateioDetalheCanonico = {
    ...
    sobraCents: 0,
    // #448 W1: `removedTargetsCount`/`hiddenTargetsCount`/`hiddenAllocationCents`
    // saíram do contrato (B1b). Esta view nunca dependeu deles — o fixture
    // sem os campos é a prova.
    items: [
