        ...
        {commitResult ? (
          <div className="text-center py-8">
            ...
            <div className="text-gray-700 space-y-1">
              <p><strong>{commitResult.inserted}</strong> novas transações</p>
              <p><strong>{commitResult.duplicated}</strong> ignoradas (duplicadas)</p>
              <p><strong>{commitResult.settled}</strong> parcelas planejadas marcadas como pagas</p>
              <p className="text-sm text-gray-500 mt-2">Período: {commitResult.periodLabel}</p>
            </div>
            <button
              onClick={onCommitted}
