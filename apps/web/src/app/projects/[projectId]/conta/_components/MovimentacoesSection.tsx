...
export function MovimentacoesSection({
  ...
  /** Habilita a CTA "Novo lançamento" no estado vazio genuíno (Conta PESSOAL). */
  onOpenLaunch?: () => void;
}) {
  ...
  // #218 (W5): vazio genuíno = nenhum dado BRUTO nas três listas de origem (não
  // `filtered`) + aba "Tudo" + sem filtro + `onOpenLaunch` fornecido.
  const hasAnyRawData =
