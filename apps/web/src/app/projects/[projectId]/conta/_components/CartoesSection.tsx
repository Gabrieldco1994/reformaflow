  ...
  return (
    <section className="space-y-2">
      ...
      <div className="-mx-1.5 flex snap-x snap-mandatory gap-2 overflow-x-auto px-1.5 pb-1 md:hidden">
        {cartoes.map((card) => (
          <div key={`card-mobile-${card.last4}`} className="w-[260px] shrink-0 snap-start">
            <CreditCardTile
              card={card}
        ...
        {contas.map((conta) => {
          ...
          return (
            <article
              ...
              className={`flex w-[220px] shrink-0 snap-start cursor-pointer items-center gap-2 rounded-2xl border bg-lifeone-card p-2.5 shadow-lifeone-card transition-colors ${
                active
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-lifeone-ink-3">conta corrente · toque para filtrar</p>
              </div>
            </article>
          );
        })}
