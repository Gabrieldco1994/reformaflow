...
export function CashFlowKpiHeader({ entries }: { entries: CashFlowKpiEntry[] }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-4">
      <div role="article" aria-label="Saldo projetado" className="min-w-0">
        <KpiTile
          variant="support"
          layer="glance"
      ...
      <div role="article" aria-label="Saldo realizado" className="min-w-0">
        <KpiTile
          variant="support"
          layer="glance"
