...
- **Desvincular na prévia:** clicar em **"Vinculado"** remove apenas o vínculo com o recebimento previsto ou a despesa planejada, mantendo as edições da linha. Já **"Restaurar"**, numa linha excluída, descarta as edições e volta à sugestão automática original.
