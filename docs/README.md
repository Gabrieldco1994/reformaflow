...
| [`plano-centro-financeiro-sdd.md`](plano-centro-financeiro-sdd.md) | SDD canônico do programa #436: **planejamento aprovado, produto/runtime não iniciado; baseline S0.3 test-only em andamento**; decisões, contratos, ondas E0–E6, dependências, riscos e changelog. |
...
|---|---|---|
| [`plano-centro-financeiro-sdd.md`](plano-centro-financeiro-sdd.md) | 📋 **Aprovado; produto/runtime não iniciado; S0.3 test-only em andamento** | Programa #436 — Centro Financeiro multi-tenant e base agent-first. |
...
**Status E0 em 2026-08-17:** #446 pode avançar test-only sob exceção PO sem aguardar #445, mas
