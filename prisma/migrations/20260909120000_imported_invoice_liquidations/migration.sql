...
CREATE TABLE "imported_invoice_liquidations" (
    ...
    CONSTRAINT "imported_invoice_liquidations_import_id_fkey" FOREIGN KEY ("import_id") REFERENCES "bank_statement_imports" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
